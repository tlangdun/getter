const fullCardContentRecruiter = {
...
const fullCardContentTalent = {
    title: "User Dashboard",
    text: "Communicate with your future employer, change your profile settings. Alot of exiting things await you."
}


const contentCardRecruiter = [
    {
        title:"Recruiting",
...
const contentCardTalent = [
    ...
    {
        title:"Messages",
        text:"Write with recruiters in the messages tab.",
        image:"https://firebasestorage.googleapis.com/v0/b/getter-38760.appspot.com/o/getter%2Fmessages-pexels-pixabay-261763.jpg?alt=media&token=53ba4e1c-e67c-40c4-b1ea-ed19c32c802a",
        link:"/dashboard/messages"
    }
]

export {fullCardContentRecruiter, contentCardRecruiter, fullCardContentTalent, contentCardTalent}