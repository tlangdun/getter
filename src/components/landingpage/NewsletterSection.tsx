                    ...
                    <div className="relative rounded-2xl px-6 py-10 bg-purple-600 overflow-hidden shadow-xl sm:px-12 sm:py-20">
                        ...
                        <div className="relative">
                            <div className="sm:text-center">
                                ...
                                <p className="mt-6 mx-auto max-w-2xl text-lg text-purple-200">
                            ...
                            {/* <form action="#" className="mt-12 sm:mx-auto sm:max-w-lg sm:flex">
                                ...
                                <div className="mt-4 sm:mt-0 sm:ml-3">
                                    <button
                                        type="submit"
                                        className="block w-full rounded-md border border-transparent px-5 py-3 bg-purple-500 text-base font-medium text-white shadow hover:bg-purple-400 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-purple-600 sm:px-10"
                                    >
                                        Notify me
                                    </button>
                                </div>
